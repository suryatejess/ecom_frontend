      ...
      <div className='flex flex-col'>
          ...
          <div className='flex flex-col'>
            ...
            <div className='grid grid-rows-2 sm:grid-cols-2 mt-4'>
                ...
                {/* image  */}
                <img src={product.image} alt="here the image of the product is supposed to be there" />
                ...
                <div>
                  <div className='flex flex-col'>
                      ...
                      <p className='text-green-600 text-sm'>{product.availableQuantity} in stock</p>
                      </div>
                  </div>
                </div>
            </div>
